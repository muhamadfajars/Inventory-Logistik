...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Logistics</b> Inventory</span>
        </a>
...
@include('layouts.sidebar')
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            Developed by Logistics Division
        </div>
        <!-- Default to the left -->
        <?php $date = date('Y')?>
        <strong>Copyright &copy; 2024 <a href="#">Logistics Division</a>.</strong> All rights reserved.
    </footer>
